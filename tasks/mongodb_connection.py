"""Run the mongodb-connection evals through claude_code().

Loads samples from agent-skills/testing/mongodb-connection/evals/evals.json
...
EVALS_PATH = Path(
    "/Users/caleb.thompson/Projects/mongodb/agent-skills/testing/mongodb-connection/evals/evals.json"
)
